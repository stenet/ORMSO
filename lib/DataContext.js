...
var DataContext = (function () {
    ...
    DataContext.prototype.updateSchema = function () {
        var _this = this;
        return h.Helpers
            .qSequential(this._dataModels, function (dataModel) {
    ...
    DataContext.prototype.addRelationInfoToTableInfo = function () {
        var _this = this;
        this._dataModels.forEach(function (dataModel) {
            ...
            return h.Helpers.qSequential(rows, function (row) {
                ...
                return dataModel.select({
                    ...
                    if (arr && arr.length === 1) {
                        ...
                        expandKeys.shift();
                        return _this.expand(expandKeys.join("/"), [arr[0]]);
                    }
                    return q.resolve(null);
                });
            });
            ...
            return h.Helpers.qSequential(rows, function (row) {
                ...
                return dataModel.select({
                    ...
                    if (arr && Array.isArray(r)) {
                        ...
                        expandKeys.shift();
                        return _this.expand(expandKeys.join("/"), arr);
                    }
                    return q.resolve(null);
                });
            });
